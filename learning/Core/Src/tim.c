...
void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM1_MspInit 0 */
    ...
    PA8     ------> TIM1_CH1
    */
    GPIO_InitStruct.Pin = ENCODER_D_B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM1;
    HAL_GPIO_Init(ENCODER_D_B_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = ENCODER_D_A_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM1;
    HAL_GPIO_Init(ENCODER_D_A_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM2_MspInit 0 */
    ...
    PB3     ------> TIM2_CH2
    */
    GPIO_InitStruct.Pin = ENCODER_A_A_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(ENCODER_A_A_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = ENCODER_A_B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(ENCODER_A_B_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM3_MspInit 0 */
    ...
    PA7     ------> TIM3_CH2
    */
    GPIO_InitStruct.Pin = ENCODER_B_A_Pin|ENCODER_B_B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM4_MspInit 0 */
    ...
    PD13     ------> TIM4_CH2
    */
    GPIO_InitStruct.Pin = ENCODER_C_B_Pin|ENCODER_C_A_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM9_MspPostInit 0 */
    ...
    PE6     ------> TIM9_CH2
    */
    GPIO_InitStruct.Pin = SERVO5_Pin|GPIO_PIN_6;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM12_MspPostInit 0 */
    ...
    PB15     ------> TIM12_CH2
    */
    GPIO_InitStruct.Pin = SERVO6_Pin|GPIO_PIN_15;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA8     ------> TIM1_CH1
    */
    HAL_GPIO_DeInit(ENCODER_D_B_GPIO_Port, ENCODER_D_B_Pin);

    HAL_GPIO_DeInit(ENCODER_D_A_GPIO_Port, ENCODER_D_A_Pin);
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB3     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(ENCODER_A_A_GPIO_Port, ENCODER_A_A_Pin);

    HAL_GPIO_DeInit(ENCODER_A_B_GPIO_Port, ENCODER_A_B_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PA7     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOA, ENCODER_B_A_Pin|ENCODER_B_B_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD13     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOD, ENCODER_C_B_Pin|ENCODER_C_A_Pin);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM11_MspDeInit 0 */
    ...
    PF7     ------> TIM11_CH1
    */
    HAL_GPIO_DeInit(ECHO_RIGHT_GPIO_Port, ECHO_RIGHT_Pin);
